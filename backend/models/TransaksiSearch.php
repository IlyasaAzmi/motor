...
class TransaksiSearch extends Transaksi
{
    ...
    {
        return [
            [['transaksi_id', 'motor_id', 'customer_id', 'paket_id', 'transaksi_start_date', 'transaksi_return_date', 'transaksi_created_at', 'transaksi_updated_at', 'created_at_range', 'payment_status'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $dataProvider = new ActiveDataProvider([
            ...
            'sort' => [
                'defaultOrder' => [
                    'transaksi_created_at' => SORT_DESC, 
                ]
            ],
        ]);
