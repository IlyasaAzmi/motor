...
$this->title = 'Katalog Motor Matic';
    ...
    <div class="col-lg-2">
        <div class="widget-wrapper wow fadeIn" data-wow-delay="0.4s">
            ...
            <div class="list-group">
                <a href="?r=catalog%2Fdaftar" class="list-group-item">All</a>
                <a href="?r=catalog%2Fmatic" class="list-group-item active">Skuter Matic</a>
